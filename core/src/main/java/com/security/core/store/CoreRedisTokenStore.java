package com.security.core.store;
...
/**
 * @description: App自定义RedisTokenStore
 * @author: sca
 * @create: 2019-08-13 13:27
 **/
public class CoreRedisTokenStore implements TokenStore {
    ...
    public CoreRedisTokenStore(RedisConnectionFactory connectionFactory) {
